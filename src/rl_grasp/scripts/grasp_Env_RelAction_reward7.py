...
class GraspEnv(py_environment.PyEnvironment):
    ...
    def __init__(self, input_image_size, phase, step_lengtn):
        ...
        print("grasp_Env_RelAction_reward7")
    ...
    def _update_reward(self):
        ...
        self._reward =  (self.pointLikelihood_right_finger) + self.pointLikelihood_grab_cloud - 1.0*(self.NormalDepthNonZero/self.MaxNormalDepthNonZero) - (self._step_counter)*0.1
